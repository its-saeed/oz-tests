...
//   xit('double voting is forbiden', async function () {
...
//       // FIXME: In https://zilliqa-jira.atlassian.net/browse/ZIL-4899
//       xit('if proposal does not meet proposalThreshold', async function () {
//         await expectRevert(
...
//       // FIXME: In https://zilliqa-jira.atlassian.net/browse/ZIL-4899
//       xit('if vote type is invalide', async function () {
//         await this.helper.propose({ from: proposer });
//         await this.helper.waitForSnapshot();
//         await expectRevert(
...
//     // FIXME: In https://zilliqa-jira.atlassian.net/browse/ZIL-4899
//     xit('cannot cancel is proposer is still above threshold', async function () {
//       await this.helper.propose({ from: proposer });
